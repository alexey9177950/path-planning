...
На данный момент реализованы алгоритмы Дейкстры, A* и Theta. Для них поддерживаются все описанные в разделе "Формат входных данных" опции. Для параметра loglevel поддерживаются значения не более 1.
